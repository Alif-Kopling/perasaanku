    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden bg-gradient-to-br from-night via-night-light to-rose-deep/30">
      ...
      >
        <motion.div
          ...
          className="mb-6"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-14 h-14 md:w-20 md:h-20 mx-auto text-rose-soft drop-shadow-lg">
            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
          </svg>
        </motion.div>

        <div className="text-white/90 text-lg md:text-3xl lg:text-4xl font-sans font-medium leading-relaxed min-h-[4rem] max-w-2xl mx-auto">
          <TypingText
        ...
        <AnimatePresence>
          {showButton && (
            ...
            >
              <button
                onClick={onStart}
                className="group px-10 py-4 md:px-16 md:py-6 rounded-full bg-gradient-to-r from-rose to-lavender text-white font-bold text-lg md:text-2xl shadow-xl shadow-rose/20 hover:shadow-2xl hover:shadow-rose/40 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer overflow-hidden"
              >
